...
$location = fetchById($pdo, $_GET['id'], "locations", "location_id");
    ...
    <div class=" dashboard-main scrollbar transition-all duration-500">
        ...
        <div class=" p-4">
            <div class=" mt-4x bg-white p-4 rounded shadow w-full max-w-[500px] m-auto">
                <div class=" text-2xl text-center">Edit Location</div>
                <form action="includes/location/update.php" method="POST" enctype="multipart/form-data" class=" app-form mt-4">
                    ...
                    <div id="file-preview" class=" w-full aspect-[3/1] rounded border-2 border-gray-300 bg-gray-100 overflow-hidden">
                        ...
                        <?php if ($location['image']) { ?>
                            <img src="<?php echo './includes/location/' . $location['image'] ?>" class=" w-full h-full object-cover" alt="">
                        <?php } ?>
                    </div>
                    ...
                    <div class=" my-2 flex flex-col gap-1 items-start">
                        ...
                        <input type="text" name="name" id="name" value="<?php echo (isset($_SESSION['input_data']['name']) && !isset($_SESSION['errors']['name'])) ? htmlspecialchars($_SESSION['input_data']['name']) : htmlspecialchars($location['name']) ?>" class=" w-full py-2 px-6 rounded bg-app-secondary/15 outline-none focus:bg-app-secondary/20">
