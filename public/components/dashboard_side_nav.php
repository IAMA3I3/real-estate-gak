...
$navLinks = [
    ...
    ['name' => 'Blog', 'url' => './blog.php', 'isActive' => isPageActive('blog.php') || isPageActive('blog_detail.php') || isPageActive('blog_add.php') || isPageActive('blog_edit.php'), 'ic' => '<i class="fa-solid fa-blog"></i>', 'access' => ["admin"]]
];
