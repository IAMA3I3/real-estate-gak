...
$navLinks = [
    ...
    ['name' => 'Properties', 'url' => './dashboard_properties.php', 'isActive' => isPageActive('dashboard_properties.php') || isPageActive('dashboard_property_detail.php') || isPageActive('property_add.php') || isPageActive('property_edit.php') || isPageActive('add_tenant.php') || isPageActive('property_remarks.php') || isPageActive('property_remark_add.php') || isPageActive('property_remark_edit.php'), 'ic' => '<i class="fa-solid fa-city"></i>', 'access' => ["admin", "landlord"]],
    ['name' => 'Rents', 'url' => './rent_history.php', 'isActive' => isPageActive('rent_history.php') || isPageActive('rent_documents.php') || isPageActive('upload_rent_document.php') || isPageActive('renew_rent.php') || isPageActive('remarks.php') || isPageActive('remark_add.php') || isPageActive('remark_edit.php'), 'ic' => '<i class="fa-solid fa-house-user"></i>', 'access' => ["admin", "landlord", "user"]],
