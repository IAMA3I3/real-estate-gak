    ...
    <div class=" dashboard-main scrollbar transition-all duration-500">
        ...
        <div class=" p-4">
            <div class=" mt-4x bg-white p-4 rounded shadow w-full max-w-[500px] m-auto">
                ...
                <form action="includes/blog/add.php" method="POST" enctype="multipart/form-data" class=" app-form mt-4">
                    ...
                    <div class=" my-2 flex flex-col gap-1 items-start">
                        ...
                        <input type="text" name="title" id="title" value="<?php echo (isset($_SESSION['input_data']['title']) && !isset($_SESSION['errors']['title'])) ? htmlspecialchars($_SESSION['input_data']['title']) : '' ?>" class=" w-full py-2 px-6 rounded bg-app-secondary/15 outline-none focus:bg-app-secondary/20">
                    ...
                    <div class=" my-2 flex flex-col gap-1 items-start">
                        ...
                        <textarea name="body" id="body" class=" w-full py-2 px-6 rounded bg-app-secondary/15 outline-none focus:bg-app-secondary/20 resize-y min-h-[150px]"><?php echo (isset($_SESSION['input_data']['body']) && !isset($_SESSION['errors']['body'])) ? htmlspecialchars($_SESSION['input_data']['body']) : '' ?></textarea>
