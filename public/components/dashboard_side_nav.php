...
$navLinks = [
    ...
    ['name' => 'Rents', 'url' => './rent_history.php', 'isActive' => isPageActive('rent_history.php') || isPageActive('rent_documents.php') || isPageActive('upload_rent_document.php') || isPageActive('renew_rent.php'), 'ic' => '<i class="fa-solid fa-house-user"></i>', 'access' => ["admin", "landlord", "user"]],
