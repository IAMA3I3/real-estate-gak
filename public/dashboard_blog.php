    ...
    <div class=" dashboard-main scrollbar transition-all duration-500">
        ...
        <div class=" p-4">
            <div class=" flex flex-col sm:flex-row items-center justify-between gap-4">
                <div class=" text-2xl text-center sm:text-left">Blog</div>
                <div class="inline-block">
                    <a href="./blog_add.php" class=" flex items-center justify-between sm:justify-normal md:text-lg gap-2 text-app-primary font-semibold hover:text-white transition border py-3 px-5 border-app-primary group bg-transparent relative">
                ...
                <table class="datatable display nowrap w-full min-w-[800px] border border-gray-200 rounded-lg overflow-hidden shadow text-sm text-left text-gray-700">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <?php foreach ($blogs as $blog) { ?>
                            <tr data-href="dashboard_blog_detail.php?id=<?php echo htmlspecialchars($blog['blog_id']) ?>" class="hover:bg-blue-50 transition cursor-pointer">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class=" max-w-[300px] text-wrap line-clamp-2"><?php echo htmlspecialchars($blog['title']) ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class=" max-w-[200px] text-wrap line-clamp-2"><?php echo htmlspecialchars($blog['body']) ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
