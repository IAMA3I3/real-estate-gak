    ...
    <div class=" dashboard-main scrollbar transition-all duration-500">
        ...
        <div class=" p-4">
            <div class=" mt-4x bg-white p-4 rounded shadow w-full max-w-[500px] m-auto">
                <div class=" text-2xl text-center">Add New Team Member</div>
                <form action="./includes/team/add-member.php" method="post" enctype="multipart/form-data" onsubmit="this.querySelector('input[type=submit]').disabled = true;" class=" mt-4">
                    ...
                    <div class=" my-2">
                        ...
                        <?php if (isset($_SESSION['errors']['fileUpload'])) { ?>
                            <div class=" text-sm font-semibold text-red-500"><?php echo $_SESSION['errors']['fileUpload'] ?></div>
                        <?php } ?>
                    </div>
                    <!--  -->
                    <div class=" my-2 flex flex-col gap-1 items-start">
                        <label for="name" class=" text-sm font-semibold text-gray-500">Name</label>
                        <input type="text" name="name" id="name" value="<?php echo (isset($_SESSION['inputData']['name']) && !isset($_SESSION['errors']['name'])) ? htmlspecialchars($_SESSION['inputData']['name']) : ''; ?>" class=" w-full py-2 px-6 rounded bg-app-secondary/15 outline-none focus:bg-app-secondary/20">
                    ...
                    <div class=" my-2 flex flex-col gap-1 items-start">
                        ...
                        <input type="text" name="position" id="position" value="<?php echo (isset($_SESSION['inputData']['position']) && !isset($_SESSION['errors']['position'])) ? htmlspecialchars($_SESSION['inputData']['position']) : ''; ?>" class=" w-full py-2 px-6 rounded bg-app-secondary/15 outline-none focus:bg-app-secondary/20">
                    ...
                    <!--  -->
                    <div class=" my-2 flex flex-col gap-1 items-start">
                        <label for="bio" class=" text-sm font-semibold text-gray-500">Bio</label>
                        <textarea name="bio" id="bio" class=" w-full py-2 px-6 rounded bg-app-secondary/15 outline-none focus:bg-app-secondary/20 resize-y min-h-[150px]"><?php echo (isset($_SESSION['inputData']['bio']) && !isset($_SESSION['errors']['bio'])) ? htmlspecialchars($_SESSION['inputData']['bio']) : ''; ?></textarea>
